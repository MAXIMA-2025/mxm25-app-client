...
const ChallengeMaxima = () => {
  return (
    ...
    >
      ...
      <Card className="font-futura w-3/4 py-2 bg-gradient-to-r from-white to-yellow-200 border-7 border-[#90171a] rounded-2xl overflow-hidden">
            ...
            <CardHeader className="p-0 space-y-2 sm:space-y-3">
              <div>
                ...
                <CardDescription className="text-[#2B2B2B] text-sm sm:text-base lg:text-lg leading-relaxed">
                  Belajar bersama MAXLEARN, mengabadikan momen dengan MAXSNAP, berkreasi bersama MAXTIVITY,
                  hingga foto bersama teman-temanmu di Photobooth! Jangan lewatkan kesempatan ini, MAXIMERS!
                </CardDescription>
              </div>
            </CardHeader>
            <CardFooter className="px-0 flex flex-col md:flex-row">
              <Button variant="clay">Baca Handbook <ArrowRight/></Button>
            </CardFooter>
          </div>
        </div>
      </Card>
